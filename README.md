...
## A simple search engine\. No external dependencies\.
...
Search engine. Works with every web server! No SQL, MTS or CGI!
...
**Level**          |Intermediate
**User Rating**    |3.2 (41 globes from 13 users)
...
**Archive File**   |[](https://github.com/Planet-Source-Code/a-simple-search-engine-no-external-dependencies__4-6216/archive/master.zip)

### API Declarations

(c)2000 ThunderSoft Inc. All Rights reserved.
